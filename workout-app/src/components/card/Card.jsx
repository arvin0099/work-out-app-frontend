...
const Card = ({ frontContent, backContent, onButtonClick, buttonColor, buttonName }) => {
  ...
  return (
    <div
      ...
      >
        <CardFront content={frontContent} onButtonClick={onButtonClick} buttonColor={buttonColor} buttonName={buttonName} />
